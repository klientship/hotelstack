  ...
  <div id="data-list-list-view" class="data-list-container">
    ...
    >
      ...
      <template slot="thead">
        ...
        <vs-th sort-key="room_type">Room Type</vs-th>
        <vs-th sort-key="floor">Floor</vs-th>
      ...
      <template slot-scope="{data}">
        <tbody>
          <vs-tr :data="tr" :key="indextr" v-for="(tr, indextr) in data">
            <vs-td>
              <p class="product-name font-medium truncate">{{ tr.number }}</p>
            </vs-td>

            <vs-td>
              <p class="product-category">{{ tr.room_type }}</p>
            </vs-td>
            <vs-td>
    ...
    <div class="demo-alignment">
      <vs-popup classContent="popup-example" title="Create Room" :active.sync="isAddNewPopup">
        <!-- ERRORS -->
          ...
          <div class="p-4">
            <div class="vx-row mb-4">
              <div class="vx-col w-full">
                <vs-input class="w-full" label-placeholder="Number" v-model="form.number" />
              </div>
            </div>
            <div class="vx-row mb-4">
              <div class="vx-col w-full">
            ...
            <div class="vx-row">
              <div class="vx-col w-full">
                ...
                <vs-button
                  ...
                  type="border"
                  class="mb-4"
                  @click="form.number = form.room_type_id = form.floor_id =  ''; form.status= 1;"
                >Reset</vs-button>
              </div>
            </div>
          </div>
...
export default {
  ...
  methods: {
    ...
    deleteData(id) {
      ...
      //     color: "danger",
      //     title: "Deleted",
      //     text: "The selected room deleted successfully.",
      //   })
      // );
    ...
    editData(data) {
      ...
      this.form.room_type_id = data.room_type_id;
    ...
    onUpdate() {
      this.form
        .submit("patch", `/api/rooms/${this.form.id}`)
        .then(() => {
          this.$store.dispatch("retrieveRooms");
          this.$vs.notify({
            color: "success",
    ...
    deleteSelected() {
      if (this.selected.length > 0) {
        this.selected.forEach((item) => {
          this.$store.dispatch("deleteRoom", item.id).then(
            this.$vs.notify({
              color: "danger",
              title: "Deleted",
              text: "The selected room was deleted successfully.",
            })
          );
        });
        this.$store.dispatch("retrieveRooms");
        ...
        this.$vs.notify({
          color: "warning",
          title: "Warning",
          text: "Please select room to delete.",
        });
      }
    },
  },
