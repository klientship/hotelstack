        ...
        <div class="mb-4 md:mb-0 mr-4 ag-grid-table-actions-left">
          <vs-dropdown vs-trigger-click class="dd-actions cursor-pointer mr-4 mb-4">
            ...
            <vs-dropdown-menu>
              ...
              <vs-dropdown-item @click="presentCheckins">
                <span class="flex items-center">
                  <span
                    :class="[filter == 'present_checkins' ? 'text-primary': '']"
          ...
          <vs-dropdown vs-trigger-click class="cursor-pointer">
            ...
            >
              <span
                class="mr-2"
              >{{ currentPage * paginationPageSize - (paginationPageSize - 1) }} - {{ reports.length - currentPage * paginationPageSize > 0 ? currentPage * paginationPageSize : reports.length }} of {{ reports.length }}</span>
              <feather-icon icon="ChevronDownIcon" svgClasses="h-4 w-4" />
            </div>
