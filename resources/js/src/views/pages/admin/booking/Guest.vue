        ...
        <div class="mb-4 md:mb-0 mr-4 ag-grid-table-actions-left">
          <vs-dropdown vs-trigger-click class="dd-actions cursor-pointer mr-4 mb-4">
            ...
            <vs-dropdown-menu>
              ...
              <vs-dropdown-item @click="present">
                <span class="flex items-center">
                  <span :class="[filter == 'present' ? 'text-primary': '']">Present Checkin</span>
                </span>
              </vs-dropdown-item>
...
export default {
  ...
  computed: {
    ...mapGetters({ invoices: "getAllGuests" }),
  ...
  methods: {
    present() {
      this.$store.dispatch("RETRIEVE_PRESENT_GUESTS");
      this.filter = "present";
    },
    thisMonth() {
      this.$store.dispatch("RETRIEVE_THIS_MONTH_GUESTS");
      this.filter = "this_month";
    },
    lastMonth() {
      this.$store.dispatch("RETRIEVE_THIS_LAST_GUESTS");
      this.filter = "last_month";
    },

    all() {
      this.$store.dispatch("RETRIEVE_ALL_GUESTS");
      this.filter = "all";
    },
